...
def  synchronise_UART(serial_port):
    """
    Synchronizes the UART communication by s ending a byte and waiting for a response.
...
if __name__ == '__main__':
    X_test = np.load(r"C:\Users\mathi\Visual Studio Code Program\POO\IAembarqued\MNIST_xtest_NN_C2_16_10.npy")
    Y_test = np.load(r"C:\Users\mathi\Visual Studio Code Program\POO\IAembarqued\MNIST_ytest_NN_C2_16_10.npy")
